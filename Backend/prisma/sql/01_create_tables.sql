...
-- Etapa 1 + Etapa 2 — DDL completo alinhado ao enunciado
-- ============================================================================
...
CREATE TABLE PROCEDIMENTO (
    ...
    media_tempo_procedimento NUMERIC(10,2) -- atualizado via trigger (Etapa 2)
);
...
CREATE TABLE INTERNACAO (
    ...
    data_hora_saida    TIMESTAMP -- NULL = ainda internado
);

-- AUDITORIA_ATENDIMENTO (populada via trigger)
